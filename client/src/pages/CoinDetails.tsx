          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              ...
              <motion.img 
                ...
                className="max-w-full max-h-full object-contain drop-shadow-2xl z-10 hover:scale-110 transition-transform duration-700 cursor-zoom-in ml-[0px] mr-[0px] pl-[232px] pr-[232px] pt-[230px] pb-[230px]"
              />
